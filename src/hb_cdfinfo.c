...
................................................................................
.
.  Reads a netCDF file created by the HydroBase 2 routines and prints a
...
main (int argc, char **argv)
{
   ...
   fprintf(stdout,"\n\nTime Bins:    ");
   for (i = 0; i < cdf.nt; ++i) {
      fprintf(stdout,"\n   index %2d : %4d to %4d", i,cdf.tmin[i],cdf.tmax[i]);
   }
...
void print_usage(char *program)
{
   ...
   fprintf(stderr,"\ncontents of a HydroBase cdf_file\n");
   fprintf(stderr,"\nUsage: %s cdf_file_name ", program);
