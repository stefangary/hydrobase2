...
void print_usage(char *program)
{
   ...
   fprintf(stderr," [-Ddirname] [-Eextent] [-K] [-P] [-S<startdist>] ");
     ...
     at dist_addr */
{
   ...
   /* Convert lon and lat to meters separation.
    * for lat, this is just a straightforward
    * application of the arc-length formula.
    * For longitude, scale by the cosine of
    * the latitude because lines of longitude
    * get closer together at the poles.  Use
    * the longitude at the center of the
    * displacement for the scaling. */
