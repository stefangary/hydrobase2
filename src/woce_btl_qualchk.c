...
.   Creates xy-files for checking salinity and oxygen versus pressure and theta vars.
.   USAGE: woce_btl2hb infile_list -Rrootname -Ssum_file  [-D<dir>] [-E<extent>]
................................................................................
*/
#include <stdio.h>
#include <stdlib.h>
...
/* assimilate lines 2,3 & 4 to determine column positions and quality byte pos */   
   ...
   prop_avail[(int)TH] = 1;
   column[(int)TH] = (int) (xx - line - 2);
   qual_offset[(int)TH] = 0;
 ...
 
{
   ...
   while ((sta == hdr.station) && (ca == cast)) {      
      ...
      error = sscanf(&line[column[(int)TH]], "%lf", &theta);
      ...
      if (prop_avail[(int)O2]) {
          ...
          switch (oqual) {
             case '2':
	        ++oq2;
	        fprintf(qual2_o2pr,"%8.1lf %8.1lf\n", oxygen, pressure);
	        fprintf(qual2_o2th,"%8.1lf %8.4lf\n", oxygen, theta);
	        if (pressure >= 1000) 
	           fprintf(qual2_deepo2th,"%8.4lf %8.4lf\n", oxygen, theta);
	        break;
             case '3':
	        ++oq3;
	        fprintf(qual3_o2pr,"%8.1lf %8.1lf\n", oxygen, pressure);
	        fprintf(qual3_o2th,"%8.1lf %8.4lf\n", oxygen, theta);
	        if (pressure >= 1000) 
	           fprintf(qual3_deepo2th,"%8.4lf %8.4lf\n", oxygen, theta);
	        break;
             case '4':
	        ++oq4;
	        fprintf(qual4_o2pr,"%8.1lf %8.1lf\n", oxygen, pressure);
	        fprintf(qual4_o2th,"%8.1lf %8.4lf\n", oxygen, theta);
	        if (pressure >= 1000) 
		...
		if (prop_avail[(int)VA] ) {
	             ...
	             fprintf(qual9_o2pr,"%8.1lf %8.1lf\n", oxygen, pressure);
	             fprintf(qual9_o2th,"%8.1lf %8.4lf\n", oxygen, theta);
	             if (pressure >= 1000) 
