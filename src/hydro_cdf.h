...
#define STD_DEV_SUFFIX  "_rms"   /* nomenclature for std deviation variables */
#define MAXSTDLEVS  2000       /* max # of standard depth levels, was 1000, sfg changed to 2000 */
#define HBMASK  .9e35          /* marks a masked node in cdf file */
#define HBEMPTY -.9e35        /* marks an empty node in cdf file */


/*  Global variables */

double std_depth[MAXSTDLEVS];  /* initialize this with std_depth_init(), was 1000, sfg changed to MAXSTDLEVS  */
