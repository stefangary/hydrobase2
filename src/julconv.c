...
iopstat = sscanf (cdate, "%2ld%2ld%2ld", &iy, &im, &id);
if (iopstat < 3)  {
...
if (iopstat != 0)  {
  fprintf (stderr, "  *** date_c6:  error validating date %ld %ld %ld\n",
           iy, im, id);
  return (iopstat);
  }
...
iopstat = sscanf (cdate, "%2ld%3s%2ld", &id, cm, &iy);
if (iopstat < 3)  {
...
iopstat = date_chk (iy, im, id);
if (iopstat != 0)  {
  fprintf (stderr, "  *** date_c7:  error validating date %ld %ld %ld\n",
           iy, im, id);
  return (iopstat);
  }
...
iopstat = sscanf (cdate, "%4ld%2ld%2ld", &iy, &im, &id);
if (iopstat < 3)  {
...
iopstat = date_chk (iy, im, id);
if (iopstat != 0)  {
  fprintf (stderr, "  *** date_c8:  error validating date %ld %ld %ld\n",
           iy, im, id);
  return (iopstat);
  }
...
iopstat = sscanf (cdate, "%2ld%3s%4ld", &id, cm, &iy);
if (iopstat < 3)  {
...
iopstat = date_chk (iy, im, id);
if (iopstat != 0)  {
  fprintf (stderr, "  *** date_c9:  error validating date %ld %ld %ld\n",
           iy, im, id);
  return (iopstat);
  }
