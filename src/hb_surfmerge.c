...
................................................................................
   ...
   Reads 2 files of gridded xyz values, stores the x,y,z values in both
  and writes out x, y, z1, z2 at gridpoints where both contain information
  .
................................................................................
*/
...
/*   allocate space for gridded values and initialize... */
  ...
  z = (float **) malloc(nrows * sizeof(float *));
   for (i = 0; i < nrows; ++i ) {
      z[i] = (float *) malloc(ncols * sizeof(float));
   }
...
/* now read second file and output points ... */

   infile = fopen(name[1], "r");
   if (infile == NULL) {
       fprintf(stderr, "\nUnable to open %s\n", name[0]);
       exit(1);
   }
   ...
   while (fscanf(infile,"%f%f%f", &lon, &lat, &zin) != EOF) {
     if (latfirst) {
        pos = lon;
	lon = lat;
	lat = pos;
     ...
     if ((row >= 0) && (row < nrows) && (col >= 0) && (col < ncols)) {
        if (z[row][col] > -99998.)
           fprintf(outfile,"%8.3f %8.3f %8.3f %8.3f\n", lon, lat, z[row][col], zin);
     }
   }
...
void print_usage(char *program)
{
  ...
  fprintf(stderr,"\ninformation and writes them out to the stdout device.");
   fprintf(stderr,"\n\nUsage:  %s file1 file2 -Bwest/east/south/north -Ideltax/deltay  > output_file", program);
